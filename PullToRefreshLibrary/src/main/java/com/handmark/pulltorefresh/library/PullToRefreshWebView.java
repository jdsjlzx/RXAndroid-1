...
public class PullToRefreshWebView extends PullToRefreshBase<WebView> {
    ...
    protected boolean isReadyForPullEnd() {
        //更改android M方法
        float exactContentHeight = Float.parseFloat(String.valueOf(Math.floor(Double.parseDouble(String.valueOf(mRefreshableView.getContentHeight() * mRefreshableView.getScale())))));
